 ...
 *
 * [ Mac OS X ]
 * compile cmd: gcc -Wall -fPIC -o rastertostarlm rastertostarlm.c -lcupsimage -lcups -arch ppc -arch i386 -DMACOSX
...
static const struct command validateNsb = 
{4,(char[4]){0x1b,0x1e,0x61,50}};
...
{{6,(char[6]){0x1b,0x1d,0x19,0x11,'1',0x01}},                     //  0 20millis
 ...
 {6,(char[6]){0x1b,0x1d,0x19,0x11,'1',0xFA}}};                    //  7 5000millis
...
{{6,(char[6]){0x1b,0x1d,0x19,0x11,'2',0x01}},                     //  0 20millis
 ...
 {6,(char[6]){0x1b,0x1d,0x19,0x11,'2',0xFA}}};                    //  7 5000millis
...
{{2,(char[2]){0xff,0x00}},                    // 0 no cut, no action
...
inline void initializeSettings(char * commandLineOptionSettings, struct settings_ * settings)
{
    ...
    switch(modelNumber)
    {
      ...
      case SP742:
      case SP717:
      case SP712:   settings->pageType              = getOptionChoiceIndex("PageType"             , ppd);
    ...
    switch(modelNumber)
    {
      ...
      case SP742:
      case SP717:
      case SP712:   settings->pageCutType           = getOptionChoiceIndex("PageCutType"          , ppd);
    ...
    {
        case SP542:
        case SP512: settings->buzzer1Setting  = 0;
